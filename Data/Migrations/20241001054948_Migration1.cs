    ...
    public partial class Migration1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveApplictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeaveApplictions_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveApplictions_LeaveTypes_LeaveTypeId",
                        column: x => x.LeaveTypeId,
                        principalTable: "LeaveTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveApplictions_SystemCodeDetails_DurationId",
                        column: x => x.DurationId,
                        principalTable: "SystemCodeDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveApplictions_SystemCodeDetails_StatusId",
                        column: x => x.StatusId,
                        principalTable: "SystemCodeDetails",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveApplictions_DurationId",
                table: "LeaveApplictions",
                column: "DurationId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApplictions_EmployeeId",
                table: "LeaveApplictions",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApplictions_LeaveTypeId",
                table: "LeaveApplictions",
                column: "LeaveTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApplictions_StatusId",
                table: "LeaveApplictions",
                column: "StatusId");
